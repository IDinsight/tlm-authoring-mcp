...
export function documentSection(actions: Actions) {
  return {
    available: actions.canPreview,
    tools: ["compose_section", "render_document", "propose_from_document", "check_stale"],
